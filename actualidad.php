<?php
// actualidad.php - Página de Actualidad (Noticias)
...
<div class="grids-block-5">
    <div class="container">
                        ...
                        <div class="grids5-info">
                            <a href="<?= obtenerLink($noticia) ?>" class="card-image" <?= targetBlank($noticia) ?>>
                                <?php if (!empty($noticia['foto'])): ?>
                                    <img src="<?= htmlspecialchars($noticia['foto']) ?>" alt="<?= htmlspecialchars($noticia['titulo']) ?>" />
                                <?php else: ?>
                                    <img src="assets/images/nota-facebook-21-11-25.png" alt="<?= htmlspecialchars($noticia['titulo']) ?>" />
                                <?php endif; ?>
                            </a>
        ...
        <div class="pagination">
            <ul>
                <li><a href="noticias.php" class="btn-ver-todos">Ver Todas Las Noticias</a></div>
    </div>
</div>
