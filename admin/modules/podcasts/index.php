...
if (isset($_GET['mensaje'])) {
    if ($_GET['mensaje'] == 'creado') { $mensaje = 'Podcast creado exitosamente'; }
    elseif ($_GET['mensaje'] == 'editado') { $mensaje = 'Podcast actualizado exitosamente'; }
    elseif ($_GET['mensaje'] == 'eliminado') { $mensaje = 'Podcast eliminado exitosamente'; }
}

$items = $pdo->query("SELECT * FROM podcasts ORDER BY fecha_publicacion DESC")->fetchAll();
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Podcasts - Panel de Administración</title>
...
<div class="sidebar" style="background: #ffffff !important; background-color: #ffffff !important; box-shadow: 2px 0 15px rgba(0,0,0,0.06) !important; border-right: 1px solid #f0f0f0 !important;">
    ...
    <nav class="nav flex-column">
        ...
        <a class="nav-link active" style="color: #e0020d !important; background: #fff5f5 !important; border-left: 3px solid #e0020d !important;" href="index.php"><i class="fas fa-podcast"></i> <span>Podcasts</span></a>
...
<div class="main-content">
    <div class="table-container">
        <div class="table-header">
            <h4><i class="fas fa-podcast"></i> Podcasts</h4>
            <a href="crear.php" class="btn-add"><i class="fas fa-plus"></i> Nuevo Podcast</a>
        </div>
        <?php if ($mensaje): ?>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php if (count($items) > 0): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="5" class="text-center">No hay podcasts</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
