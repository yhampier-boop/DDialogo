...
<div class="sidebar">
    ...
    <nav class="nav flex-column">
        ...
        <a class="nav-link active" href="index.php"><i class="fas fa-folder"></i> <span>Reportaje</span></a>
...
<div class="main-content">
    <div class="form-container">
        <h4><i class="fas fa-plus-circle"></i> Nuevo Reportaje</h4>
