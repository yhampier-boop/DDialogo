                        ...
                        <div class="boletin-card">
                            ...
                            <?php if (!empty($boletin['archivo_pdf'])): ?>
                                <a href="<?= htmlspecialchars($boletin['archivo_pdf']) ?>" class="btn btn-style btn-primary" target="_blank">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style="vertical-align: middle; margin-right: 5px;"><path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"/></svg> Descargar PDF
                                </a>
                            <?php endif; ?>
                        </div>
                    </div>
