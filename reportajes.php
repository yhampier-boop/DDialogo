<?php
// reportajes.php - Lista de reportajes
require_once 'config/database.php';

$stmt = $pdo->query("SELECT * FROM reportajes ORDER BY fecha_publicacion DESC");
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="grids5-info">
                            <a href="reportaje.php?id=<?= $reportaje['id'] ?>" class="card-image">
                                <img src="<?= htmlspecialchars(obtenerImagen($reportaje)) ?>" alt="<?= htmlspecialchars($reportaje['titulo']) ?>" />
                            </a>
